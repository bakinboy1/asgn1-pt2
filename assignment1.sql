...
(4, 'Math','Intermediate math',3,'placeholder description'),
(7, 'Math','Advanced math',4,'placeholder description'),
(2, 'English','Intro to english',4,'placeholder description'),
(5, 'English','Intermediate english',4,'placeholder description'),
(8, 'English','Advanced english',3,'placeholder description'),
(3, 'History','Intro to history',4,'placeholder description'),
(6, 'History','Intermediate history',3,'placeholder description'),
...
(2, 2, 11112, 2, 'T,TH', '3:00 - 4:00 PM', 'stanley 226', 1),
(3, 3, 21111, 1, 'M,W,F', '4:00 - 5:00 PM', 'stanley 225', 1),
(1, 4, 21112, 2, 'T,TH', '5:00 - 6:00 PM', 'cct 425', 2),
(2, 5, 31111, 1, 'M,W,F', '6:00 - 7:00 PM', 'cct 425', 2),
(3, 6, 31112, 2, 'T,TH', '7:00 - 8:00 PM', 'lenoir 215', 2),
(1, 7, 41111, 1, 'M,W,F', '8:00 - 9:00 PM', 'lenoir 215', 3),
(2, 8, 41112, 2, 'T,TH', '8:00 - 9:00 AM', 'stanley 125', 3),
